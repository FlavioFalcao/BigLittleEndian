...
#define BigtoLittle32(A)   ((( (int)(A) & 0xff000000) >> 24) | (( (int)(A) & 0x00ff0000) >> 8) | (( (int)(A) & 0x0000ff00) << 8)  | (( (int)(A) & 0x000000ff) << 24))
#define BigtoLittle16(A)   (( ((int)(A) & 0xff00) >> 8)    | \
                                       (( (int)(A) & 0x00ff) << 8))
int BigLittleEx(int a)
{
    printf("test: %x, %x, %x\n", (((int)a)&0xffffffff), (((int)a)&0x0000ff00), ((((int)a)&0x0000ff00)<<8));
    return (int)((((int)a)&0xff000000)>>24 | (((int)a)&0x00ff0000)>>8 | (((int)a)&0x0000ff00)<<8 | (((int)a)&0x000000ff)<<24);
}
